            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <tbody>
                    <c:forEach items="${allTexts}" var="text" varStatus="s">
                    <tr>
                      <th scope="row">${text.id}</th>
                      <td>${text.title}</td>
                      <td>
                        <form action="${pageContext.request.contextPath}/admin/set-text" method="post">
                          <input type="hidden" name="id" value="${text.id}"/>
                          <input type="hidden" name="action" value="set"/>
                          <button type="submit" class="btn btn-success">Set Next</button>
                        </form>
                      </td>
                    </tr>
                    </c:forEach>
